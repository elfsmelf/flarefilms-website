...
export const metadata: Metadata = {
  title: "St George Wedding Videographer | Flare Films",
  description: "Award-winning St George wedding videographer capturing story-driven, candid wedding films. Serving St George, the Balonne region and rural Queensland. View our portfolio.",
  openGraph: {
    title: "St George Wedding Videographer | Flare Films",
    description: "Award-winning St George wedding videographer capturing story-driven, candid wedding films.",
    url: "https://flarefilms.com.au/st-george-wedding-videographer",
...
export default async function StGeorgeWeddingVideographerPage() {
  // Fetch films from St George and surrounding region (including Roma)
  const locationFilms = await db.query.films.findMany({
    where: and(
      eq(films.published, true),
      or(
        ilike(films.location, '%St George%'),
        ilike(films.location, '%St. George%'),
        ilike(films.location, '%Roma%')
      )
    ),
  ...
  // Fetch venues in St George area
  const locationVenues = await db.query.venues.findMany({
    where: and(
      eq(venues.published, true),
      or(
        ilike(venues.city, '%St George%'),
        ilike(venues.city, '%St. George%'),
        ilike(venues.venueLocation, '%St George%'),
        ilike(venues.venueLocation, '%St. George%')
      )
    ),
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative h-[90vh]">
        <Image
          ...
          alt="St George wedding videography - outback Queensland wedding"
          fill
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white px-4">
          ...
          <h1 className="text-[40px] md:text-[50px] lg:text-[65px] font-cormorant tracking-[0.05em] uppercase mb-4 font-medium leading-[1.1]" style={{ textShadow: "rgba(0, 0, 0, 0.46) 0px 0px 10px" }}>
            St George Wedding Videographer
          </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="flex flex-col justify-center z-10">
              ...
              <div className="space-y-6 text-base md:text-lg font-sans leading-relaxed opacity-90">
                ...
                <p>
                  St George and the Balonne region hold a special place in my heart. The wide open skies, stunning sunsets, and the warm community spirit of rural Queensland create the perfect setting for authentic, heartfelt wedding films.
                </p>
              </div>
            ...
            <div className="relative">
              <div className="relative aspect-[3/4] w-full overflow-hidden">
                <Image
                  ...
                  alt="Richard Paynter - St George Wedding Videographer"
                  fill
                  className="object-cover"
      ...
      {/* Filming in St George Section */}
      <section className="bg-[#E7E4DF] py-20 md:py-28">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="font-cormorant text-3xl md:text-4xl lg:text-5xl text-[#3d3a35] mb-6">
                Filming Wedding Videos In St George
              </h2>
              <div className="font-sans text-lg text-[#5a534b] leading-relaxed space-y-4">
                <p>
                  St George is the heart of Queensland's cotton country, where the Balonne River winds through vast plains and the sunsets paint the sky in brilliant colours. There's something magical about weddings in this part of the world.
                </p>
                <p>
                  I love filming weddings in St George—the sense of community, the beautiful rural properties, and those incredible outback skies create footage that's truly unique. The warmth and hospitality of country weddings always shines through in the final film.
                </p>
              </div>
            </div>
            <div className="relative aspect-video">
              <Image src="https://assets.guestsnapper.com/wedding-gallery-media/Jess-and-Braydan-21-scaled.jpg" alt="St George Wedding" fill className="object-cover" sizes="(max-width: 1024px) 100vw, 50vw" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white py-20 md:py-28">
        <div className="max-w-4xl mx-auto px-6">
          <h2 className="font-cormorant text-3xl md:text-4xl lg:text-5xl text-[#3d3a35] mb-6 text-center">
            Why is St George Great For A Wedding Video?
          </h2>
          <div className="font-sans text-lg text-[#5a534b] leading-relaxed space-y-4">
            <p>
              St George offers a wedding experience unlike anywhere else. The vast open landscapes, golden light, and genuine country hospitality create an atmosphere that's both intimate and cinematic. When the sun sets over the cotton fields, the sky comes alive with colours you won't find anywhere else.
            </p>
            <p>
              As a wedding videographer, I treasure filming in St George. Drone footage captures the endless horizons and winding Balonne River, while the close-knit community means every wedding is filled with heartfelt moments. Country weddings have a special authenticity that translates beautifully to film.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            <p className="font-sans text-xs uppercase tracking-[0.3em] text-[#d4c9a0] mb-4">
              St George Wedding Venue Ideas
            </p>
            <h2 className="font-cormorant text-3xl md:text-4xl lg:text-5xl text-white mb-6">
              Popular Wedding Venues In St George
            </h2>
            <p className="font-sans text-lg text-[#e8e3d8] leading-relaxed max-w-3xl mx-auto">
              From historic woolsheds to beautiful rural properties, St George and the Balonne region offer unique outback wedding venues.
            </p>
          </div>
          ...
          {locationVenues.length > 0 ? (
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-white/10 backdrop-blur-sm p-6">
                <h3 className="font-cormorant text-2xl text-[#d4c9a0] mb-3">Rural Properties</h3>
                <p className="font-sans text-[#e8e3d8] leading-relaxed mb-4">
                  Beautiful family farms and stations offer authentic outback wedding experiences with stunning landscapes.
                </p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm p-6">
                <h3 className="font-cormorant text-2xl text-[#d4c9a0] mb-3">Riverside Venues</h3>
                <p className="font-sans text-[#e8e3d8] leading-relaxed mb-4">
                  The Balonne River provides a picturesque backdrop for ceremonies and receptions.
                </p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm p-6">
                <h3 className="font-cormorant text-2xl text-[#d4c9a0] mb-3">Historic Woolsheds</h3>
                <p className="font-sans text-[#e8e3d8] leading-relaxed mb-4">
                  Converted woolsheds and historic buildings offer rustic charm with plenty of character.
                </p>
              </div>
            </div>
          )}
