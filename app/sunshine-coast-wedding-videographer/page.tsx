...
export const metadata: Metadata = {
  title: "Sunshine Coast Wedding Videographer | Flare Films",
  description: "Award-winning Sunshine Coast wedding videographer capturing story-driven, candid wedding films. Serving Maleny, Montville, Mooloolaba and surrounds. View our portfolio.",
  openGraph: {
    title: "Sunshine Coast Wedding Videographer | Flare Films",
    description: "Award-winning Sunshine Coast wedding videographer capturing story-driven, candid wedding films.",
    url: "https://flarefilms.com.au/sunshine-coast-wedding-videographer",
...
export default async function SunshineCoastWeddingVideographerPage() {
  // Fetch films from Sunshine Coast location
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative h-[90vh]">
        <Image
          ...
          alt="Sunshine Coast wedding videography"
          fill
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="flex flex-col justify-center z-10">
              ...
              <div className="space-y-6 text-base md:text-lg font-sans leading-relaxed opacity-90">
                ...
                <p>
                  The Sunshine Coast is one of Queensland's most beautiful wedding destinations—from the stunning hinterland villages of Maleny and Montville to the golden beaches of Mooloolaba and Caloundra.
                </p>
              </div>
            ...
            <div className="relative">
              <div className="relative aspect-[3/4] w-full overflow-hidden">
                <Image
                  ...
                  alt="Richard Paynter - Sunshine Coast Wedding Videographer"
                  fill
                  className="object-cover"
      ...
      {/* Filming on the Sunshine Coast Section */}
      <section className="bg-[#E7E4DF] py-20 md:py-28">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="font-cormorant text-3xl md:text-4xl lg:text-5xl text-[#3d3a35] mb-6">
                Filming Wedding Videos On The Sunshine Coast
              </h2>
              <div className="font-sans text-lg text-[#5a534b] leading-relaxed space-y-4">
                <p>
                  The Sunshine Coast offers an incredible diversity of wedding locations. The famous hinterland villages of Maleny and Montville provide stunning mountain views and charming country atmosphere, while the coastal towns offer beautiful beach ceremonies.
                </p>
                <p>
                  I've filmed countless weddings across the Sunshine Coast and know all the best spots for capturing that perfect golden hour light or those sweeping mountain views with my drone.
                </p>
              </div>
            </div>
            <div className="relative aspect-video">
              <Image src="/images/2024/03/Jess-and-Braydan-21-scaled.jpg" alt="Sunshine Coast Wedding Venue" fill className="object-cover" sizes="(max-width: 1024px) 100vw, 50vw" />
            </div>
          </div>
        </div>
      </section>

      {/* Why Sunshine Coast Section */}
      <section className="bg-white py-20 md:py-28">
        <div className="max-w-4xl mx-auto px-6">
          <h2 className="font-cormorant text-3xl md:text-4xl lg:text-5xl text-[#3d3a35] mb-6 text-center">
            Why is the Sunshine Coast Great For A Wedding Video?
          </h2>
          <div className="font-sans text-lg text-[#5a534b] leading-relaxed space-y-4">
            <p>
              The Sunshine Coast is blessed with incredible natural beauty—from the Glass House Mountains to the pristine beaches. The hinterland offers lush rainforests, rolling green hills, and panoramic views, while the coast provides stunning beach backdrops.
            </p>
            <p>
              As a wedding videographer, I love the variety the Sunshine Coast offers. Whether you're getting married at a mountain-top venue with sweeping views or a beachfront location with crashing waves, there's always something spectacular to capture.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            <p className="font-sans text-xs uppercase tracking-[0.3em] text-[#d4c9a0] mb-4">
              Sunshine Coast Wedding Venue Ideas
            </p>
            <h2 className="font-cormorant text-3xl md:text-4xl lg:text-5xl text-white mb-6">
              Popular Wedding Venues On The Sunshine Coast
            </h2>
            <p className="font-sans text-lg text-[#e8e3d8] leading-relaxed max-w-3xl mx-auto">
              From hinterland retreats to coastal venues, the Sunshine Coast has something for every couple.
            </p>
          </div>
          ...
          {locationVenues.length > 0 ? (
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-white/10 backdrop-blur-sm p-6">
                <h3 className="font-cormorant text-2xl text-[#d4c9a0] mb-3">Maleny Manor</h3>
                <p className="font-sans text-[#e8e3d8] leading-relaxed mb-4">
                  One of the Sunshine Coast's most iconic venues, offering breathtaking views over the Glass House Mountains.
                </p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm p-6">
                <h3 className="font-cormorant text-2xl text-[#d4c9a0] mb-3">Flaxton Gardens</h3>
                <p className="font-sans text-[#e8e3d8] leading-relaxed mb-4">
                  Beautiful manicured gardens with stunning coastal views and a charming chapel.
                </p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm p-6">
                <h3 className="font-cormorant text-2xl text-[#d4c9a0] mb-3">Spicers Clovelly Estate</h3>
                <p className="font-sans text-[#e8e3d8] leading-relaxed mb-4">
                  A luxury boutique retreat in Montville offering intimate celebrations.
                </p>
              </div>
            </div>
          )}
